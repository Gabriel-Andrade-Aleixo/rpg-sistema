...
O Supabase/Postgres não é acessado diretamente pelo web. O navegador conversa apenas com o backend.
...
Regras ausentes no catálogo permanecem indisponíveis; o web não cria valores genéricos.
