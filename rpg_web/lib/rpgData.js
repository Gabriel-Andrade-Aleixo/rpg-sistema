...
export function emptyCharacter() {
  ...
  return {
    ...
    combatContext: { enemyWithinTwoMeters: false, darkOrNight: false, hotEnvironment: false, coldEnvironment: false, withoutSunlight: false, blinded: false, inCombat: false, separatedFromConnection: false },
